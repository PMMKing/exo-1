 ...
 *
 */
public class MainHXSDKHelper extends com.easemob.applib.controller.HXSDKHelper {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventOfflineMessage:
                    if(activityList.size() <= 0){
                        ...
                        com.easemob.applib.controller.HXSDKHelper.getInstance().getNotifier().onNewMesg(messages);
                    }
                    break;
