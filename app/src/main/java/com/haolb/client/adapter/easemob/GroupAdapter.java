...
public class GroupAdapter extends ArrayAdapter<EMGroup> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == 0) {
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.z_search_bar_with_padding, null);
			}
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.z_row_add_group, null);
			}
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.z_row_group, null);
			}
