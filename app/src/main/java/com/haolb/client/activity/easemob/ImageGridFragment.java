...
import com.easemob.util.ImageCache;
import com.easemob.util.ImageResizer;
import com.easemob.domain.VideoEntity;
import com.easemob.util.Utils;
import com.easemob.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(R.layout.z_image_grid_fragment,
				container, false);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(R.layout.z_choose_griditem, container,false);
