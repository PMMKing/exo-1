...
import com.haolb.client.adapter.easemob.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.z_fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// contact list
		contactList = MainApplication.getInstance().getContactList();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (adapter.getItem(position).getUsername().equals(MainApplication.getInstance().getUserName()))
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), R.layout.z_row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
