package com.wuye.wuye.utils.graphics;
...
public class Dimen {
    ...
    static{
        DisplayMetrics dm = WApplication.getContext().getResources().getDisplayMetrics();
    ...
    public static float dpToPx(float dp) {
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, WApplication.getContext().getResources()
                .getDisplayMetrics());
    }

    public static int dpToPx(int dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, WApplication.getContext().getResources()
                .getDisplayMetrics());
    }
    /**
    ...
    public static float pxToDp(float px) {
        final float scale = WApplication.getContext().getResources().getDisplayMetrics().density;
        return px / scale;
    }
